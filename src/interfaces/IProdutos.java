...
/**
 * Interface que especifica os métodos míninos para manipular uma coleção de
 * produtos
 * 
 * @author Aline
 */
public interface IProdutos {
     ...
     * 
     * @param p Produto
     * @throws java.lang.Exception Lança exceção quando o produto não pode ser
     *                             adicionado.
     */
     ...
     *                             porque não existe produto cadastrado com o código
     *                             informado.
     */
     ...
     *                             código informado ou quando a nova quantidade é
     *                             inválida.
     */
     ...
     * @throws java.lang.Exception Lança exceção quando não existe produto com o
     *                             código informado ou quando o novo preço é
     *                             inválido.
     */
     ...
     * @throws java.lang.Exception Lança exceção quando não existe produto com o
     *                             código informado ou quando a quantidade é
     *                             inválida.
     */
     ...
     * @throws java.lang.Exception Lança exceção quando não existe produto com o
     *                             código informado ou quando quantidade informada é
     *                             inválida.
     */
